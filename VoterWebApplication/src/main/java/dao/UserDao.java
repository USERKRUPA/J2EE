...
//add a method to get user details under specific role n dob range
	...
	// add a method to get candidate having highest and 2nd highest votes
	List<Candidate> getHighestCandidate() throws SQLException;

	// add a metod to get all email ids
