...
public class UserDaoImpl implements UserDao {
	...
	public UserDaoImpl() throws SQLException {
		...
		pstUpdate = connection.prepareStatement("update users set status = 1 where id=? ");
	...
	@Override 
	public String updateStatus(int userId) throws SQLException{
		pstUpdate.setInt(1, userId);
		int rowCount = pstUpdate.executeUpdate();
		if (rowCount == 1)
			return "You have casted vote successfully";
		return null;
	}
